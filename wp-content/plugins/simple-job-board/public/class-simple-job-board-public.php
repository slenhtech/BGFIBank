...
class Simple_Job_Board_Public {
    ...
    public function __construct($simple_job_board, $version) {
        ...
        // Action -> Load Templates functions.
    ...
    public function enqueue_styles() {
         ...
         * class.
         */
        wp_register_style($this->simple_job_board . '-bootstrap', 'https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css');
        wp_register_style($this->simple_job_board . '-google-fonts', 'https://fonts.googleapis.com/css?family=Lato:400,400italic,700,700italic,900,900italic,300italic,300', array(), $this->version, 'all');
        wp_register_style($this->simple_job_board . '-frontend', plugin_dir_url(__FILE__) . 'css/simple-job-board-public.css', array(), $this->version, 'all');
        wp_register_style($this->simple_job_board . '-validate-telephone-input', plugin_dir_url(__FILE__) . 'css/intlTelInput.css', array(), $this->version, 'all');
    }
