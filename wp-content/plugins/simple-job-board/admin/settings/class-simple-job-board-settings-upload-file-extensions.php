...
/**
 * This is used to define uploaded file extesnions settings.
 *
    ...
    public function save_settings_section() {
        ...
        if (( isset($_POST['file_extensions']) && '' != $_POST['file_extensions']) || isset($_POST['empty_file_extensions'])) {
            ...
            if (isset($_POST['file_extensions'])) {
                ...
                (FALSE !== get_option('job_board_upload_file_ext')) ? update_option('job_board_upload_file_ext', $_POST['file_extensions']) : add_option('job_board_upload_file_ext', $_POST['file_extensions'], '', 'no');
            }
