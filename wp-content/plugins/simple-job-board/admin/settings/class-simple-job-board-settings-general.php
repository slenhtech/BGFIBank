...
/**
 * This is used to define job board general settings.
 *
 * This file saves the slugs of custom post type and taxomimies. User can 
...
?>
    ...
    public function save_settings_section() {
        if ( isset( $_POST['jobpost_slug'] ) || isset( $_POST['job_category_slug'] ) || isset( $_POST['job_type_slug'] ) || isset( $_POST['job_location_slug']) ) {
            ...
            ( isset( $_POST['jobpost_slug'] ) && '' != $_POST['jobpost_slug'] ) ? update_option( 'job_board_jobpost_slug', esc_attr( $_POST['jobpost_slug'] ) ) : '';

            // Save Category Taxonomy Slug in WP Option
            ( isset( $_POST['job_category_slug'] ) && '' != $_POST['job_category_slug'] ) ? update_option( 'job_board_job_category_slug', esc_attr( $_POST['job_category_slug'] ) ) : '';

            // Save Job Type Taxonomy Slug in WP Option
            ( isset( $_POST['job_type_slug'] ) && '' != $_POST['job_type_slug'] ) ? update_option( 'job_board_job_type_slug', esc_attr( $_POST['job_type_slug'] ) ) : '';

            // Save Job Location Taxonomy Slug in WP Option
            ( isset( $_POST['job_location_slug'] ) && '' != $_POST['job_location_slug'] ) ? update_option( 'job_board_job_location_slug', esc_attr( $_POST['job_location_slug'] ) ) : '';
        }
    }
