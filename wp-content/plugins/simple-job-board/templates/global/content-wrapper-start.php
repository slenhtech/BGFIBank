...
// Appearance Settings -> User Defined Container Id
$container_id = (get_option('job_board_container_id')) ? strtolower(get_option('job_board_container_id')) : 'container';
...
switch ($template) {
    ...
    case 'twentysixteen' :
        ...
        break;
    default :
        echo '<div class="' . $container_class . '" id="' . $container_id . '"><div id="content" class="sjb-content" role="main">';
        break;
}