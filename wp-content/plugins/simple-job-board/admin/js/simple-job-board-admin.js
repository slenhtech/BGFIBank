    ...
    $(function () {
        ...
        $('#settings_addFeature').on("click", function () {
            ...
            if (fieldName != '') {
                ...
                $('#settings_job_features').append('<li class="' + fieldName + '"><label for="' + fieldName + '">' + settings_application_form.admin_jquery_alerts['field_name'] +': ' + field_name_raw + '</label>\n\
                    <input type="hidden"  name="jobfeature[]" value="jobfeature_' + fieldName + '"  >' + jobfeature_value_textbox + ' &nbsp;\n\
                    <div class="button removeField" >' + settings_application_form.admin_jquery_alerts['delete'] +'</div></li>');
        ...
        $('#app_add_field').on("click", function () {
            ...
            if (app_field_name != '') {
                ...
                $('#settings_app_form_fields').append('<li class="jobapp_' + app_sanitized_field_name + '">\n\
                    ...
                    <input type="hidden"   name="field_optional[]"  value="' + isRequired + '"/>' + settings_application_form.admin_jquery_alerts['required'] +'\
                    &nbsp; <div class="button removeField">' + settings_application_form.admin_jquery_alerts['delete'] +'</div></li>');
