(function ($) {
    ...
    $(document).ready(function () {
        ...
        $(".jobpost_form").on("submit", function (event) {
            ...
            if (!is_valid_email || !is_valid_phone || !($.inArray(file_ext, selected_file_exts) > -1) ) {
                return false;
            }
        ...
        // Hide & Show logo and description according to settings.
        ...
        /**
         * Job Filterd -> Remove Background Color When no Filter to Show.
         * @since 2.2.0 
         */
