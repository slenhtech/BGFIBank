 ...
 * @since   2.2.3
 */
function sjb_front_end_styles() {
    
    // Enqueue Styles
    wp_enqueue_style('simple-job-board-bootstrap');
    wp_enqueue_style('simple-job-board-google-fonts');
    wp_enqueue_style('simple-job-board-frontend');
    wp_enqueue_style('simple-job-board-validate-telephone-input');
}

add_action('sjb_enqueue_styles', 'sjb_front_end_styles');
