...
class Simple_Job_Board_Admin {
    ...
    public function __construct($simple_job_board, $version) {
         ...
         */
        require_once plugin_dir_path(dirname(__FILE__)) . 'admin/class-simple-job-board-meta-boxes-init.php';
    ...
    public function enqueue_scripts() {
        ...
        if(is_admin()) {
            ...
            wp_enqueue_script($this->simple_job_board . '-meta-boxes', plugin_dir_url(__FILE__) . 'js/simple-job-board-admin-meta-boxes.js', array('jquery'), $this->version, FALSE);
            ...
            // Localize Script for Making Meta Boxes jQuery Stings Translation Ready
            wp_localize_script($this->simple_job_board . '-meta-boxes', 'admin_meta_box', array(
                'admin_jquery_alerts'    => array(
                    'delete'             => __('Delete', 'simple-job-board'),
                    'required'           => __('Required', 'simple-job-board'),
