 ...
 * @since       1.0.0
 * @since       2.2.2   Added "sjb_notifications_template" filter.
...
class Simple_Job_Board_Notification {
    ...
    public static function job_notification_templates($post_id, $notification_receiver) {
        ...
        if ('applicant' != $notification_receiver) {
            ...
            $message .= '<p>I sincerely believe that my educational qualifications and extra-curricular activities will be appropriate for the job and the type of applicant it possible requires.'
         ...
         * @param  string  $notification_receiver  Notification Receiver 
         */
        return apply_filters('sjb_notifications_template', $message, $post_id, $notification_receiver);
    }
