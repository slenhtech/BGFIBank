...
/**
 * This is used to define the job board rewrite rules.
 *
 * These rewrite rules prevent the hotlinking of resumes & also force resumes to download rather than opening in browser.
 *
 * @since      2.1.0
 * 
 * @package    Simple_Job_Board
